...
class SingleStatCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    ...
    this.addEditorTab('گزینه ها', 'public/app/plugins/panel/singlestat/editor.html', 2);
    this.addEditorTab('نگاشت ها', 'public/app/plugins/panel/singlestat/mappings.html', 3);
