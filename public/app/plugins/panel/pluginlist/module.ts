...
class PluginListCtrl extends PanelCtrl {
  ...
  constructor($scope, $injector, private backendSrv, private $location) {
    ...
    this.pluginList = [];
    this.viewModel = [
      { header: 'اپ های نصب شده', list: [], type: 'app' },
      { header: 'پنل‌های نصب شده', list: [], type: 'panel' },
      { header: 'منابع داده نصب شده', list: [], type: 'datasource' },
    ];
  ...
  onInitEditMode() {
    ...
    this.addEditorTab('گزینه ها', 'public/app/plugins/panel/pluginlist/editor.html');
  }
